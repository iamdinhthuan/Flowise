...
export class ChatOpenRouter extends LangchainChatOpenAI implements IVisionChatModal {
    ...
    private injectCacheControl(messages: BaseMessage[]): BaseMessage[] {
        ...
        return messages.map((msg, index) => {
            ...
            const shouldCache =
                ...
                (index === messages.length - 2 && msg instanceof HumanMessage) // second-to-last = context
            ...
            if (typeof content === 'string') {
                ...
                const newMsg = msg instanceof SystemMessage
                    ? new SystemMessage({
                ...
                const newMsg = msg instanceof SystemMessage
                    ? new SystemMessage({ content: newContent })
    ...
    async _generate(
        ...
        return super._generate(cachedMessages, options, runManager)
    }
}
